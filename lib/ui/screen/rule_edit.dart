                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                TextFormField(
                                  ...
                                  validator: (value) {
                                    if (value == null || value.isEmpty) {
                                      return 'rule_edit.rule_name_validator'
                                          .tr();
                                    }
                                    return null;
                                  },
                                ...
                                TextFormField(
                                  ...
                                  validator: (value) {
                                    if (value == null || value.isEmpty) {
                                      return 'rule_edit.base_url_validator'
                                          .tr();
                                    }
                                    if (value.contains('://')) {
                                ...
                                TextFormField(
                                  ...
                                  validator: (value) {
                                    if (value == null || value.isEmpty) {
                                      return 'rule_edit.logo_url_validator'
                                          .tr();
                                    }
                                    return null;
                                  },
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText: 'rule_edit.search_url_label'
                                        .tr(),
                                  ...
                                  validator: (value) {
                                    if (value == null || value.isEmpty) {
                                      return 'rule_edit.search_url_validator'
                                          .tr();
                                    }
                                    if (value.contains('://')) {
                                      return 'rule_edit.base_url_protocol_validator'
                                ...
                                DropdownButtonFormField<RequestMethod>(
                                  ...
                                  decoration: InputDecoration(
                                    labelText: 'rule_edit.request_method_label'
                                        .tr(),
                                    border: OutlineInputBorder(
                                      borderRadius: BorderRadius.all(
                                        Radius.circular(20.0),
                                ...
                                AnimatedSize(
                                  ...
                                  child:
                                      ...
                                      : TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                            labelText: '请求体'.tr(),
                                            hintText: 'key与value用=隔开,多个用英文逗号隔开'
                                                .tr(),
                                            border: OutlineInputBorder(
                                              borderRadius: BorderRadius.all(
                                                Radius.circular(20.0),
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText: 'rule_edit.search_selector_label'
                                        .tr(),
                                    hintText: 'rule_edit.search_selector_hint'
                                        .tr(),
                                    border: OutlineInputBorder(
                                      borderRadius: BorderRadius.all(
                                        Radius.circular(20.0),
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText:
                                        'rule_edit.item_img_selector_label'
                                            .tr(),
                                    hintText: 'rule_edit.item_img_selector_hint'
                                        .tr(),
                                    border: OutlineInputBorder(
                                      borderRadius: BorderRadius.all(
                                        Radius.circular(20.0),
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText:
                                        'rule_edit.item_title_selector_label'
                                            .tr(),
                                    hintText:
                                        'rule_edit.item_title_selector_hint'
                                            .tr(),
                                    border: OutlineInputBorder(
                                      borderRadius: BorderRadius.all(
                                        Radius.circular(20.0),
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText:
                                        'rule_edit.item_id_selector_label'.tr(),
                                    hintText: 'rule_edit.item_id_selector_hint'
                                        .tr(),
                                    border: OutlineInputBorder(
                                      borderRadius: BorderRadius.all(
                                        Radius.circular(20.0),
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText:
                                        'rule_edit.item_genre_selector_label'
                                            .tr(),
                                    hintText:
                                        'rule_edit.item_genre_selector_hint'
                                            .tr(),
                                    border: OutlineInputBorder(
                                      borderRadius: BorderRadius.all(
                                        Radius.circular(20.0),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText: 'rule_edit.detail_url_label'
                                        .tr(),
                                  ...
                                  validator: (value) {
                                    if (value == null || value.isEmpty) {
                                      return 'rule_edit.detail_url_validator'
                                          .tr();
                                    }
                                    if (value.contains('://')) {
                                      return 'rule_edit.base_url_protocol_validator'
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText: 'rule_edit.line_selector_label'
                                        .tr(),
                                    hintText: 'rule_edit.line_selector_hint'
                                        .tr(),
                                    border: OutlineInputBorder(
                                      borderRadius: BorderRadius.all(
                                        Radius.circular(20.0),
                                  ...
                                  validator: (value) {
                                    if (value == null || value.isEmpty) {
                                      return 'rule_edit.line_selector_validator'
                                          .tr();
                                    }
                                    return null;
                                  },
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText:
                                        'rule_edit.episode_selector_label'.tr(),
                                    hintText: 'rule_edit.episode_selector_hint'
                                        .tr(),
                                    border: OutlineInputBorder(
                                      borderRadius: BorderRadius.all(
                                        Radius.circular(20.0),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText: 'rule_edit.player_url_label'
                                        .tr(),
                                  ...
                                  validator: (value) {
                                    if (value == null || value.isEmpty) {
                                      return 'rule_edit.player_url_validator'
                                          .tr();
                                    }
                                    if (value.contains('://')) {
                                      return 'rule_edit.base_url_protocol_validator'
                                ...
                                TextFormField(
                                  enabled: widget.isEditMode,
                                  initialValue:
                                      widget.rule?.playerVideoSelector,
                                  decoration: InputDecoration(
                                    labelText:
                                        'rule_edit.player_video_selector_label'
                                            .tr(),
                                    hintText:
                                        'rule_edit.player_video_selector_hint'
                                            .tr(),
                                    border: OutlineInputBorder(
                                      borderRadius: BorderRadius.all(
                                        Radius.circular(20.0),
                                ...
                                TextFormField(
                                  enabled: widget.isEditMode,
                                  initialValue:
                                      widget.rule?.videoElementAttribute,
                                  decoration: InputDecoration(
                                    labelText:
                                        'rule_edit.video_element_attribute_label'
                                            .tr(),
                                    hintText:
                                        'rule_edit.video_element_attribute_hint'
                                            .tr(),
                                    border: OutlineInputBorder(
                                      borderRadius: BorderRadius.all(
                                        Radius.circular(20.0),
                                ...
                                SwitchListTile(
                                  ...
                                  onChanged: widget.isEditMode
                                      ...
                                      : null,
                                  title: Text(
                                    'rule_edit.wait_for_media_element_label'
                                        .tr(),
                                  ),
                                  subtitle: Text(
                                    'rule_edit.wait_for_media_element_subtitle'
                                        .tr(),
                                  ),
                                ),
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText:
                                        'rule_edit.embed_video_selector_label'
                                            .tr(),
                                    hintText:
                                        'rule_edit.embed_video_selector_hint'
                                            .tr(),
                                    border: OutlineInputBorder(
                                      borderRadius: BorderRadius.all(
                                        Radius.circular(20.0),
