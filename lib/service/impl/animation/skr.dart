...
class Skr extends Common {
  Skr()
    : super(
        rule: Rule(
          name: "Sky",
          baseUrl: "https://skr.skr2.cc:666",
          logoUrl: "https://img.yingk.sbs:8443/upload/site/logo_black.png",
          useWebView: false,
          searchUrl: "/vodsearch/-------------/?wd={keyword}",
          fullSearchUrl: false,
          searchRequestMethod: RequestMethod.get,
          searchSelector: "li.searchlist_item",
          itemIdSelector: "h4>a",
          itemTitleSelector: "h4>a",
          itemImgSelector: "div>a",
          itemImgFromSrc: false,
          itemGenreSelector: "span.vodlist_top",
          detailUrl: "{mediaId}",
          fullDetailUrl: false,
          detailRequestMethod: RequestMethod.get,
          lineSelector: "div.play_list_box",
          episodeSelector: "div.playlist_full>ul>li>a",
